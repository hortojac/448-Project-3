...
tictactoe_button = Button(frame1, text="Tic Tac Toe",font=("Arial",20, BOLD), padx=25, pady=25, command=lambda: tictactoe.playGame()).grid() #place(relx=.5,rely=.6,anchor= CENTER)
